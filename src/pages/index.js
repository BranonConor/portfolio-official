					...
					<div className='content'>
						<div className='left'>
							<motion.p
								...
								With a degree in behavioral neuroscience, a
								creative eye for stunning and ergonomic UX/UI
								design, and a powerful command of modern
								technologies to build quality interfaces and
								experiences, my strengths lie at the
							...
							<motion.p
								...
								My passion is building intuitive, accessible
								software that delights users and propels
								businesses forward.
							</motion.p>
							<motion.div
								className='my-work'
