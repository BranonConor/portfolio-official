        ...
        <section className='docs'>
            <div className="two-column">
                ...
                >
                    <div className="left">
                        <p>
                            My wife and I used to live in a tiny apartment on the third floor of a rather large complex. Figuring out what to wear each day was a challenge, as we were 
                            too lazy to walk all the way down three flights of stairs to find out the answer to that question, and my wife always runs cold. Instead of heading downstairs,
                            we'd make an educated guess as to what we should wear for the day, usually ending up in disappointment when we finally left to discover it was much warmer or
                            colder than it appeared.
                        </p>
                        ...
                        <p>
                            The controversy around neumorphism is mostly related to its lack of accessibility. In standard UX/UI design, colors, shadows, borders, and more are manipulated 
                            to create a clear visual hierarchy on the page that reflects the users' options in interacting with the app. Neumorphism essentially throws all of that away, 
                            sticking to monotonous colors and creating varying depth of field in the app's interface with box shadows. It's thus considered pretty poor on the accessibility
                            front since users have to do a lot more work in figuring out the interface, and anyone with visual impairments will likely have a rough time making sense of it.
                        </p>
                        <p>
                            Nevertheless, I like to stay up to date on technology trends, and I have to admit I love the look of neumorphism. Why not give it a try. 
                        </p>
                        ...
                        <p>
                            ...
                            passed to the front end, conditional logic in the templates will render clothing suggestions based on the temperature for the location that the user searched. Pretty neat! 
                        ...
                        <p>
                            Building this web app helped me get a solid grasp on accessing data from 3rd party APIs, as well as handling that data using javascript servers in NodeJS/Express, making sure
                            it finds its way into the front end properly. Writing more and more server code in projects like this is a great way to sharpen my backend engineering skills!
                        </p>
                        <p>
                            It was also a great dive into some modern UX design trends, implementing neumorphism in the UI and seeing its advantages and disadvantages firsthand.
                        </p>
                        <p>
                            Overall, I this was a fun project with a lot of utility, as my wife and I now get to use it instead of having to use the stairs to figure out what to wear.
