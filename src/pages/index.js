        ...
        <div className="two-column">
          ...
          <div className="content">
            <div className="left">
              ...
              >
                With a degree in behavioral neuroscience, a creative eye for
                stunning and ergonomic UX/UI design, and a powerful command of
                modern technologies to build quality interfaces and experiences,
                my strengths lie at the intersection of technology and people.
              </motion.p>
              <motion.p
                className="subtitle-white"
                initial={{ x: -75, opacity: 0 }}
              ...
              >
                My passion is building intuitive, accessible software that
                delights users and propels businesses forward.
              </motion.p>
              <motion.div
                className="my-work"
                initial={{ x: -75, opacity: 0 }}
